...
public class WePushFragmentFinished extends Fragment {
...
//        return super.onCreateView(inflater, container, savedInstanceState);
        View view = inflater.inflate(R.layout.mypush_fragment_finished,container,false);
        recyclerView = (RecyclerView)view.findViewById(R.id.my_push_fragment_finished) ;
    ...
    public void inition(){
            ...
            avQuery1.whereEqualTo("isReceived",true);

            AVQuery<AVObject> avQuery2 = new AVQuery<>("Task");
            avQuery2.whereEqualTo("isEnd",false);

        AVQuery<AVObject>avObjectAVQuery = AVQuery.and(Arrays.asList(avQuery,avQuery1,avQuery2));
