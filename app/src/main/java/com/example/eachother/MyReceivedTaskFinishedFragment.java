...
public class MyReceivedTaskFinishedFragment extends Fragment {
...
//        return super.onCreateView(inflater, container, savedInstanceState);
        View view=inflater.inflate(R.layout.my_received_finished,container,false);

        inition();
        recyclerView = (RecyclerView)view.findViewById(R.id.my_received_finished_recycle);
...
//                        String UserHeadImag = avObject.getAVFile("UserHeadImag").getUrl();
                    ...
                    Toast.makeText(getContext(),"不好意思，出现了一点问题",Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
